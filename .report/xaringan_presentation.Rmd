...
- when covariance = 0, the replications of being significant / total replication
- when covariance = 0.5, the replications of being significant / total replication
...
.panel[.panel-name[code]
```{r }
rmse_p <- makePlot(bias_res, what = "RMSE", font_size = 12)
bias_p <- makePlot(bias_res, what = "Bias", font_size = 12)
power_p <- makePlot(power_res, what = "power", font_size = 12)
typeierror_p <- makePlot(power_res, what = "typeIerror", font_size = 12)
```
]
...
ggpubr::ggarrange(rmse_p, bias_p,
                  ncol = 2, nrow = 1,
                  common.legend = T)
